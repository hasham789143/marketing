...
export default function RegisterPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      // If a shop was specified, send the connection request
      if (verifiedShop) {
          const newConnection = {
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              {verifiedShop && (
                <Alert>
                    ...
                    <AlertDescription>You are requesting to connect to: <strong>{verifiedShop.name}</strong></AlertDescription>
                </Alert>
              )}
