...
export function ProductTable({ isOwner: isOwnerProp, user, isLoading: isLoadingProp }: ProductTableProps) {
  ...
  const isLoading = isLoadingProp || isUserDataLoading || areProductsLoading;
